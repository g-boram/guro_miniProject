...
//		수정 시작 null, undefined 방지
		let uId = $("#uId").val() ? $("#uId").val().trim() : "";
		$("#uId").val(uId);
		let uPw = $("#uPw").val() ? $("#uPw").val().trim() : "";		
		$("#uPw").val(uPw);		
		let uPw_Re = $("#uPw_Re").val() ? $("#uPw_Re").val().trim() : "";	
		let uName = $("#uName").val() ? $("#uName").val().trim() : "";
		$("#uName").val(uName);
		let uEmail_01 = $("#uEmail_01").val() ? $("#uEmail_01").val().trim() : "";
		let uEmail_02 = $("#uEmail_02").val() ? $("#uEmail_02").val().trim() : "";
		$("#uEmail").val(uEmail_01+"@"+uEmail_02);
		let uBirthday = $("#uBirthday").val() ? $("#uBirthday").val().trim() : "";
//		수정 끝
